...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1 class="text-capitalize">Create New Item</h1>
                    ...
                    <div class="card">
                        <form method="POST" action="{{ route('admin.why-choose-us.store') }}"
                            ...
                            <div class="card-header d-flex align-items-center justify-content-between">
                                <h4 class="text-capitalize">Informations</h4>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="icon-picker-wrapper">
                                                <button type="button" class="btn btn-secondary" id="icon-picker-btn"
                                                    ...
                                                    data-icon="{{ old('icon', 'fas fa-star') }}" role="iconpicker"></button>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" id="title"
                                                ...
                                                value="{{ old('title') }}" placeholder="Enter item title" required>
                                            @error('title')
    ...
    <script>
        $(document).ready(function() {
            ...
            var iconPickerInstance = $('#icon-picker-btn').iconpicker({
                ...
                unselectedClass: '',
                container: false // Don't use container, we'll handle positioning manually
