            ...
            <div class="row justify-content-between">
                <div class="col-lg-4 col-sm-8 col-md-6">
                    <div class="fp__footer_content">
                        <a class="footer_logo">
                            <img src="FoodPark" alt="FoodPark" class="img-fluid w-100">
                        </a>
                        <span>FoodPark
                        </span>
                        ...
                        <a class="info"><i class="fas fa-envelope"></i>
                            FoodPark</a>
                    </div>
                </div>
                    ...
                    <div class="fp__footer_content">
                        <div class="fp__footer_social_link">
                            ...
                            <ul class="d-flex flex-wrap">
                                ...
                                <li><a><i class="fab fa-twitter"></i></a>
                                </li>
                                <li><a><i class="fab fa-behance"></i></a>
                                </li>
